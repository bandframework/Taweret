...
<html lang="en" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>markdown-it-deflist &#8212; Taweret -- a Python Package for Bayesian model mixing</title>
...
<link rel="preload" as="script" href="../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8d27b9dea8ad943066ae" />
  <script src="../../../../../../_static/vendor/fontawesome/6.5.1/js/all.min.js?digest=8d27b9dea8ad943066ae"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.book/lib64/python3.10/site-packages/mdit_py_plugins/deflist/README';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../_sources/.book/lib64/python3.10/site-packages/mdit_py_plugins/deflist/README.md" target="_blank"
...
<p><a class="reference external" href="https://github.com/markdown-it/markdown-it-deflist/blob/master/LICENSE">MIT</a></p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.book/lib64/python3.10/site-packages/mdit_py_plugins/deflist"
        },
