...
mix_model = BL(models_dic=models, method='calibrate_model_1', nargs_model_dic={'Grad':17, 'PTB':17}, same_parameters = True, product=True)
...
outdir = 'outdir/calibration_grad_20000_product_likelihood'
...
if find_map_param == True:
    ...
    rslt=optimize.basinhopping(lambda x: -mix_model.mix_loglikelihood(x[0:0],[x],
                                                                      x_exp=g, 
                                                                      y_exp=exp_data[0], 
                                                                      y_err=exp_data[1]), 
